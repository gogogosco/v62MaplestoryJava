...
function action(mode, type, selection) {
    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (preamble == null) {
                cm.sendNext("Hi. Welcome to the " + nthtext + " stage. This is like the 2nd stage, but everyone has to co-operate. There are 6 portals here. One is guarded by undefeatable monsters, and one is very high. I'd like you and your party to go in each one and break the boxes inside. Bring back the drops-- there should be 24!");

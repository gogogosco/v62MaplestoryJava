...
public class GMCommand {
    ...
    public static boolean executeGMCommand(MapleClient c, MessageCallback mc, String line) {
        ...
        if (splitted[0].equals("!chattype")) {
        ...
        } else if (splitted[0].equals("!killmap")) {//null not needed, you're in map/server too
            for (MapleCharacter mch : player.getMap().getCharacters()) {
                mch.setHp(0);
            ...
            player.setReborns(Integer.parseInt(splitted[1]));
            ...
            try {
                ...
                mc.dropMessage(splitted[1] + " is null and could not be banned.");
            }
